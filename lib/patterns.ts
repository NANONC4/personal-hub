...
export const darkDiamondSvg = encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80"><path d="M39 30 h2 v4 h4 v2 h-4 v4 h-2 v-4 h-4 v-2 h4 z" fill="rgba(0,0,0,0.1)"/></svg>`);
...
export const patterns = [
  ...
  // 3: Dark Pixel Sparkles (Diamonds for light backgrounds)
  {
    backgroundImage: `url('data:image/svg+xml;utf8,${darkDiamondSvg}')`,
