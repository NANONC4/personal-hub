...
export function SpaceShooterMiniGame({ className = "" }: SpaceShooterMiniGameProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('spaceShooterGamepad', handleGamepad);
    ...
    return () => {
      ...
      window.removeEventListener('spaceShooterGamepad', handleGamepad);
    };
  }, []);
