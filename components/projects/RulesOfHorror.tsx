    ...
    <HorizontalScrollWrapper bgClass="bg-[#4a0d0d]" buttonTextClass="text-red-500">
      ...
      <div className="w-full lg:w-[70vw] h-auto lg:h-full flex-shrink-0 flex items-center justify-center mr-0 lg:mr-24 px-0 lg:px-4">
        <motion.div 
          ...
          className="w-full h-[70vh] rounded-[2rem] overflow-hidden shadow-2xl relative border border-red-900/20 group"
        >
          <img src={project.gallery[0]} alt="Horror Scene 1" className="w-full h-full object-cover scale-105 group-hover:scale-100 transition-transform duration-[2s]" />
      ...
      <div className="w-full lg:w-[90vw] h-auto lg:h-full flex-shrink-0 flex items-center justify-center mr-0 lg:mr-24 px-0 lg:px-4">
        <div className="w-full h-[70vh] flex gap-4 md:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="w-1/3 h-[60%] rounded-[2rem] overflow-hidden shadow-2xl border border-red-900/20"
          >
            <img src={project.gallery[1]} alt="Gameplay 1" className="w-full h-full object-cover opacity-70 hover:opacity-100 transition-all duration-700" />
          </motion.div>
          
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.3 }} viewport={{ once: true, amount: 0.3 }}
            className="w-1/3 h-[90%] rounded-[2rem] overflow-hidden shadow-2xl border border-red-900/20 relative z-10"
          >
            <img src={project.gallery[2]} alt="Gameplay 2" className="w-full h-full object-cover" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="w-1/3 h-[60%] rounded-[2rem] overflow-hidden shadow-2xl border border-red-900/20"
          >
            <img src={project.gallery[3]} alt="Gameplay 3" className="w-full h-full object-cover opacity-70 hover:opacity-100 transition-all duration-700" />
          </motion.div>
